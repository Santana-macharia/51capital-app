...
public class RegisterActivity extends AppCompatActivity {
    ...
    String HttpUrl = "http:// 192.168.0.15/login/signup.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String regexPassword = "^(?=.*[0-9])(?=.*[a-z])(?=.*[!@#$%^&*+=?-]).{8,15}$";
    ...
    public void regUser(){
        ...
        String myurl = "https://51capitalcrypto.com/userapp/signup.php" + NameHolder +
